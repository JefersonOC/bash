...
echo 'The following aliases have been created: apt-install, apt-installed, apt-remove, apt-purge, apt-update, apt-upgrade, apt-search, apt-add-repo, apt-remove-repo'
